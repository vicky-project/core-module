...
return [
	"backup" => [
		 ...
		 * the backups.
		 */
		"name" => env("APP_NAME", "laravel-backup") . "-modules",
		...
		"source" => [
			"files" => [
				...
				"exclude" => [
					...
					base_path("Modules/*/node_modules"),
					base_path("Modules/*/vendor"),
				],
		 ...
		 */
		"temporary_directory" => storage_path("app/module-backup-temp"),
